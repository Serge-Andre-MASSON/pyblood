...
st.markdown("""- Dataviz: visualisation des données sous forme graphiques et en affichant les images.""" ) 
st.markdown("""- Preprocessing des données: outils de sélection et de réduction de features sur les images.""")
...
st.write("\n")
st.write("Nous avons pu identifier les sources potentielles d'erreur faîtes par notre modèle:")
st.markdown("""- Erreur de labellisation par le médecin.""")
st.markdown("""- Apparition de 2 cellules par champ au lieu d'une seule.""")
